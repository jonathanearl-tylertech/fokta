...
export class WellknownController {
  ...
  openidConfiguration() {
    return {
      ...
      "authorization_endpoint": "http://localhost:5001/oauth2/v1/authorize",
      "token_endpoint": "http://localhost:5001/oauth2/v1/token",
      "userinfo_endpoint": "http://localhost:5001/oauth2/v1/userinfo",
      "registration_endpoint": "http://localhost:5001/oauth2/v1/clients",
      "jwks_uri": "http://localhost:5001/oauth2/v1/keys",
      ...
      "introspection_endpoint": "http://localhost:5001/oauth2/v1/introspect",
